 ...
 * v4.31.5
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement } from './index-65c81b5d.js';
import { l as load } from './index-877bad04.js';
import { i as importCoreReactiveUtils, al as newWidgetsVersionManagementVersionManagementViewModel } from './index-7838e72e.js';
import { u as useT9n, m as makeViewModelController } from './useViewModel-3ee4390f.js';
import { u as useControllerManager } from './index-fe1504ea.js';
import './component-utils-b19c1de2.js';

const versionManagementCss = ".calcite-combobox-item{width:330px}.calcite-flow-widget{width:350px}calcite-block{margin:0}calcite-pagination{justify-content:center}";
...
const ArcgisVersionManagement = class {
    ...
    render() {
        const { allowEditingDisabled, closable, flowElement, label, messages, mode, pageSize, viewModel, viewModel: { loadError, state }, } = this;
        ...
        const serviceItems = state !== "disabled" ? (h(Fragment, null, arrayServiceNames.map((service) => {
            const serviceItemElementProps = {
                ...
                heading: label,
                isVersionAdministrator: viewModel.versionAdministratorLookup.get(service.url),
        ...
        return (h("calcite-flow", { ref: (node) => {
            ...
            }, class: this.mode === "dialog" ? "" : "calcite-flow-widget" }, h("calcite-flow-item", { closable: this.closable, heading: label ?? undefined, onCalciteFlowItemClose: () => {
                this._handleFlowItemClose();
    ...
    _createVersionPropertiesFlowItem(serviceUrl, versionInfo) {
        ...
        versionProperties.versionPropertiesElementProps = {
            ...
            isVersionAdministrator: viewModel.versionAdministratorLookup.get(serviceUrl),
            serviceUrl,
            state,
