...
const useCatalogLayerListWidget = useWidget.makeWidgetController(index$3.newWidgetsCatalogLayerList);
const ArcgisCatalogLayerList = class {
    constructor(hostRef) {
        ...
        this.catalogItems = index$1.getSet(undefined, {
...
exports.arcgis_catalog_layer_list = ArcgisCatalogLayerList;
