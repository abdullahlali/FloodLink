...
const useBuildingExplorerWidget = useWidget.makeWidgetController(index$3.newWidgetsBuildingExplorer);
const ArcgisBuildingExplorer = class {
    constructor(hostRef) {
        ...
        this.arcgisPropertyChange = index$2.usePropertyChange()("level", "phase", "state");
...
const ArcgisScene = class {
    constructor(hostRef) {
        ...
        this.camera = index$1.getSet(undefined, {
            ...
            set: (newValue, oldValue) => {
                ...
                if (!componentUtils.areCamerasEqual(oldValue, newValue)) {
                    this.view.camera = newValue;
                }
                return this.view.camera;
            },
        });
        this.cameraFov = index$1.getSet(undefined, {
        ...
        this.cameraHeading = index$1.getSet(undefined, {
        ...
        this.cameraPosition = index$1.getSet(undefined, {
            get: (value) => this.view.camera?.position ?? value,
            set: (newValue) => {
                if (!this.ready) {
                    return newValue;
                }
                const parsed = componentUtils.parsePoint(this.view.camera?.position, newValue);
                if (parsed) {
                    this._mutateCamera((camera) => {
        ...
        this.cameraTilt = index$1.getSet(undefined, {
    ...
    render() {
        return index.h("div", { key: '9e1393b9ac8da70c9e35a8267d0261689b50e075', class: "arcgis-scene", ref: this._setChildElement });
    }
    ...
    _editViewProperties(properties) {
        ...
        const cameraPosition = componentUtils.parsePoint(undefined, this.cameraPosition);
        if (cameraPosition) {
            properties.camera ??= {};
    ...
    _mutateCamera(mutator) {
        ...
        mutator(camera);
        if (!componentUtils.areCamerasEqual(this.view.camera, camera)) {
