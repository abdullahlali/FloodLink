...
const index$1 = require('./index-04f8523d.js');
const componentUtils = require('./component-utils-e4944926.js');
const disconnected = require('./disconnected-7042ec70.js');
...
const ArcgisUtilityNetworkValidateTopology = class {
    ...
    async componentDidLoad() {
        ...
        const widget = await index$1.newWidgetsUtilityNetworkValidateTopology(params);
        this.widget = widget;
        this._addContainer();
    ...
    render() {
        return index.h("div", { key: '4f8773b76688aecd458ac939a0b0cf4a5db40e37', ref: (el) => (this.el.childElem = el) });
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
...
exports.arcgis_utility_network_validate_topology = ArcgisUtilityNetworkValidateTopology;
