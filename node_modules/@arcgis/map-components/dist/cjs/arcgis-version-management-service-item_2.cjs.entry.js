...
const ArcgisVersionManagementServiceItem = class {
    ...
    render() {
        const { serviceItemElementProps: { allowEditing, closable, currentUser, executionError, currentVersionIdentifier, flowElement, hasAdvEditingUte, heading, isVersionAdministrator, isVersioningApiAvailable, mode, pageSize, serviceName, serviceUrl, state, strings, versionInfos, }, } = this;
        let { _versionList: versionList } = this;
        const comboboxVersions = (index.h("calcite-combobox", { key: '50fa51468e10039693438024795a150b5417b918', clearDisabled: true, label: serviceName, maxItems: 5, overlayPositioning: "fixed", selectionMode: "single-persist", onCalciteComboboxChange: (event) => {
            ...
            ? versionInfos.map((versionInfo) => (index.h("calcite-combobox-item", { class: mode === "dialog" ? "" : "calcite-combobox-item", selected: currentVersionIdentifier.guid === versionInfo.versionIdentifier.guid &&
        ...
        if (allowEditing) {
            actionManageVersions = (index.h("calcite-action", { key: '7cb234cf1340018c6fc8b4290094f0de08071a69', id: `actionManageVersions_${serviceName}`, icon: "list", scale: "s", slot: "control", text: "", onClick: async () => {
            ...
            tooltipManageVersions = (index.h("calcite-tooltip", { key: '7ff6c308de3022a0f5e55e78f62dd098b259cb4d', overlayPositioning: "fixed", referenceElement: `actionManageVersions_${serviceName}` }, index.h("span", { key: 'c7f08a7ccd04af05d408b3c6c4aa90f17b85b8c2' }, strings.headers.manageVersions)));
        }
        return (index.h("calcite-block", { key: '66789d7258187bae5516aa1df18668c458fca7b0', open: true, heading: serviceName }, comboboxVersions, actionManageVersions, tooltipManageVersions));
    }
    //--------------------------------------------------------------------------
    //
    //  Private Methods
...
const ArcgisVersionManagementVersionProperties = class {
    ...
    render() {
        ...
        const buttons = (index.h("div", { key: '4a5ed7a0f6814895500189b645f9e5d3f7a9fbb5' }, index.h("calcite-button", { key: '54ab974a2bf7be9360b48dfd9f0d8a5032fe1ff7', appearance: "outline", slot: "footer", width: "half", onClick: this._handleCancel }, strings.actions.cancelSave), index.h("calcite-button", { key: '609eda7c7b1d751f21f09bf98aacb312bee87a36', slot: "footer", width: "half", onClick: this._handleSave }, strings.actions.saveVersion)));
        const chipGroupAccessLevel = (index.h("calcite-label", { key: 'f4bd072664d6f7054fa78ac4f5f5223eeea205e8' }, strings.input.versionAccess, index.h("calcite-chip-group", { key: '78f9efb602fff0ca15127da9b224e999799cb079', label: "access", onCalciteChipGroupSelect: this._handleChange, selectionMode: "single-persist" }, index.h("calcite-chip", { key: 'c8106baf12a236640d93920562d8a87d26cc3f81', selected: (mode === "edit" && versionInfo.access === "public") || mode === "create", value: "public" }, strings.accessLevels.public), index.h("calcite-chip", { key: '3806c1b9ec6c5ce7bf170a5f3091d4dbceeeb198', selected: mode === "edit" && versionInfo.access === "protected", value: "protected" }, strings.accessLevels.protected), index.h("calcite-chip", { key: '5333ff937c91ae845da5d5df63b82da277766d2a', selected: mode === "edit" && versionInfo.access === "private", value: "private" }, strings.accessLevels.private))));
        const inputDescription = (index.h("calcite-label", { key: '541d4ef40c6f00c834825d6dc167d291bacd1720' }, strings.input.versionDescription, index.h("calcite-text-area", { key: '56f9df5f6b4c7e8d4b96a246cc44a1f560b92787', name: "description", onCalciteTextAreaInput: this._handleChange, resize: "vertical", value: mode === "edit" ? versionInfo.description : "" })));
        const inputName = (index.h("calcite-label", { key: '4a96f29e7de41ab3aada75347c492ee75875a75b' }, strings.input.versionName, index.h("calcite-input-text", { key: 'b6e13fb362c9e7173f122e4ec30ae63f0ef22563', ref: (node) => {
        ...
        const inputOwner = (index.h("calcite-label", { key: 'b40998587ea68b0895e2c1111e3ff012adef4865' }, strings.input.versionOwner, index.h("calcite-input-text", { key: '4bc775b26f384eff73e7e03d5af9a2665a50eebc', name: "ownerName", onCalciteInputTextInput: this._handleChange, disabled: !hasAdvEditingUte, value: mode === "edit" ? ownerName : currentUser })));
        ...
        return (index.h("calcite-flow-item", { key: '405059a80ad768940085fc18b1fdf499af6d926c', closable: closable, description: versionInfo ? versionInfo.versionIdentifier.name : "", heading: versionInfo ? strings.actions.editVersion : strings.actions.newVersion, onCalciteFlowItemClose: this._handleClose }, index.h("calcite-panel", { key: '7b2c15adc638fbd27da93f0cdedb1cd4f7759fa9', loading: state === "executing" }, index.h("calcite-block", { key: '6a0a68fcde667eda85ce5785f0902c5c6b94c8b0', heading: "", open: true }, inputName, inputDescription, chipGroupAccessLevel, inputOwner, switchToVersionCheckbox, buttons))));
    }
    get el() { return index.getElement(this); }
};
